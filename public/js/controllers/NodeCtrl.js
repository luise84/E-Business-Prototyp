angular.module('NodeCtrl', []).controller('NodeController', ['$scope', 'NodeFactory', '$location','$routeParams', 'VisDataSet', 
    function($scope, node, $location, $routeParams, VisDataSet) {
